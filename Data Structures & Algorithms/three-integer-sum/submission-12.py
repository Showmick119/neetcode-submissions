...
to inefficiency.
- Data structures which are required for output are excluded from the auxiliary
space. As auxiliary space only counts the extra TEMPORARY memory used by the
algorithm. It excludes the required input and output memory.
"""