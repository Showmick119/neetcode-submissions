    ...
    def numRescueBoats(self, people: List[int], limit: int) -> int:
        ...
        while l <= r:
            if l == r:
                ...
                count += 1
                r -= 1
                ## the heaviest should go, because the lightest may have a match
                ## in the future, with some other element with whom it can sum to
                ## be less than or equal to the limit. But the heaviest most
                ## definitely won't, as it's the liability between the 2 options.
            elif people[l] + people[r] <= limit:
                count += 1
                l += 1
                r -= 1
