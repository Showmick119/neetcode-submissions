class Solution {
    public int rob(int[] nums) {
        ...
        */
        ...
        // IF dp[2] is best answer for house at index 2. Then, dp[n] is
        // best answer for house at index n, as it is summing up
        // everything till that, and changing it in-place. So no need
        // to create an extra index, to store "max robbery till index
        // i is stored in index i + 1. We do the summing in the next
        // index." NO. WE DO THE SUMMING AND CALCULATION IN PLACE,
        // IN THAT EXACT INDEX. This way, we can use direct indexes
        // like 2, to calculate max houses till index 2, etc.
