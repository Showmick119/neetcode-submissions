class DSU {
    ...
    */
    ...
    Whenever both ranks same. We choose an arbitrary one.

    NODE IS THE INDEX, AND PARENT IS THE VALUE AT THAT INDEX, IN THE
    PARENT ARRAY.
    */
    public boolean union(int n1, int n2) {
        ...
        if (rank[p2] > rank[p1]) {
            ...
            // since rank is same, we choose an arbitrary one
            parent[p1] = p2;
            rank[p2]++;
        }
        return true;
