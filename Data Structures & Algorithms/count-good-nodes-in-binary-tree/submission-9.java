...
class Solution {
    ...
    */
    ...
    private int dfs(TreeNode root, int maxVal) {
        ...
        // everything in that specific subtree
        // the value at the top, still comes in the path, so it must
        // be considered. Doesn't matter if it was broken apart into
        // a deeper subtree. It was there at the start, so it is in the
        // path at some point and must affect and be considered.
