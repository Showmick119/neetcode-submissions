class Solution {
    ...
    private void helper(int i, int[] candidates, int target, List<Integer> currSet, List<List<Integer>> subsets) {
        ...
        helper(i + 1, candidates, target - candidates[i], currSet, subsets);

        // how fast it returns determines if it is included or not
        // remove recent element, and try with next element
        // [1, 2, 3], REMOVE LAST and try with 4 => [1, 2, 4]
        ...
        helper(i + 1, candidates, target, currSet, subsets);
    }
